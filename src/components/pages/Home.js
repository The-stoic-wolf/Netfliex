          ...
          <div className={` ${window.innerWidth <= 576 ? "h-[560px] w-[94%] " : " h-[680px] w-[90%]" } `}>
             <div className={` ${window.innerWidth <= 576 ? "" : "" } flex items-center flex-col w-[100%] mt-[10px]`}>
                ...
                <details id='box1' className={` ${window.innerWidth <= 576 ? "w-[96%] my-[10px]" : "w-[90%] my-[5px]" } group text-white  `}>
                  ...
                  <div className={` ${window.innerWidth <= 576 ? "px-[15px] h-[250px] rounded-[15px] " : " px-[50px] h-[300px]" }  pt-[10px] text-white  bg-[#323232] mt-[2px]  `}>
                ...
                <details id='box1' className={` ${window.innerWidth <= 576 ? "w-[96%] my-[10px]" : "w-[90%] my-[5px]" } group text-white  `}>
                  ...
                  <div className={` ${window.innerWidth <= 576 ? "px-[15px] rounded-[15px] h-[270px]" : "px-[50px] h-[300px]" } pt-[10px] text-white  bg-[#323232] mt-[2px] `}>
